...
export const DeleteStoreMenuItem = ({id, name, addressId}: { id: string, name: string, addressId : string }) => {
    return (
        <DeleteStoreDialog id={id} name={name} addressId={addressId} asChild>
