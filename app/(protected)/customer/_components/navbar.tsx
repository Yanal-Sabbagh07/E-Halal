        ...
        <MaxWidthWrapper >
            <nav className={"bg-foreground rounded-xl h-[60px] flex items-center justify-between "}>
                ...
                <div className={"ml-16 flex gap-x-24"}>
                    <Button asChild variant={pathname === "/customer/server" ? "default" : "outline"}>
                        <Link href={"/customer/server"}> C_Server </Link>
                    </Button>
                    <Button asChild variant={pathname === "/customer/client" ? "default" : "outline"}>
                        <Link href={"/customer/client"}> C_Client </Link>
                    </Button>
                    <Button asChild variant={pathname === "/customer/admin" ? "default" : "outline"}>
                        <Link href={"/customer/admin"}> C_Admin </Link>
                    </Button>
                </div>
